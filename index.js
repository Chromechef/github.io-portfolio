...
const stmpToken = process.env.STMP_AUTH_TOKEN;
const stmpMailTo = process.env.STMP_TO_MAIL;
// const stmpMailFrom = process.env.STMP_FROM_MAIL;
console.log(stmpMailFrom)
